...
public class PurchaseInvoicePDF extends AbstractPdfView implements View {
	...
	protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter writer,
			...
			List<PurchaseOrderDetails> poDtlsList = (List<PurchaseOrderDetails>) model.get("list");
			...
			PdfPCell cell1 = new PdfPCell(new Phrase("INVOICE",font));
			...
			for(PurchaseOrderDetails od:poDtlsList)
			{
